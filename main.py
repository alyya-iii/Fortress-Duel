...
bq2=pygame.image.load('Pictures/background.png')
springBq = pygame.image.load('Pictures/spring.png')
summerBq = pygame.image.load('Pictures/summer.png')
autumnBq = pygame.image.load('Pictures/fall.png')
winterBq = pygame.image.load('Pictures/winter.png')
springBlock = pygame.image.load('Pictures/springBlock.png')
summerBlock = pygame.image.load('Pictures/summerBlock.png')
autumnBlock = pygame.image.load('Pictures/fallBlock.png')
winterBlock = pygame.image.load('Pictures/winterBlock.png')
springChar = pygame.image.load('Pictures/SpringChar.png')
summerChar = pygame.image.load('Pictures/SummerChar.png')
autumnChar = pygame.image.load('Pictures/FallChar.png')
winterChar = pygame.image.load('Pictures/WinterChar.png')
c = pygame.image.load('Pictures/cannon.png')
